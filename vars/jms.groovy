...
files:APPLICATION_DIR+'/'+BUILD_DIR,
...
downloadNexusArtifact repo:RELEASE_NEXUS_REPO,groupId:GROUP_ID,artifactId:APPLICATION,extension:ARTIFACT_EXTENTION,version:VERSION,release: true
    ...
    //                     }
		...
		//	azureFunctionAppPublish azureCredentialsId: 'sp-jenkins', resourceGroup: DEV_REG_NAME, appName: DEV_FUNC_NAME,filePath: APPLICATION_DIR
