...
stages{
    ...
    stage('Publish') {
     steps{        
          ...
          sh 'cd $PWD/target/azure-functions/func-001-fxs-daw-atlas-raw-transfer-dev && func azure functionapp publish func-001-fxs-daw-atlas-raw-transfer-dev --publish-local-settings -i'
           sh 'az logout'
